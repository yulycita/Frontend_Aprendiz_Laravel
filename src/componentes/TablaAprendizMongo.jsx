...
const TablaAprendizMongo = ({ data, onEditar, onEliminar, loading }) => {
  return (
    <TableContainer component={Paper} elevation={0} sx={{ border: "1px solid", borderColor: "divider" }}>
      <Table size="small">
        <TableHead sx={{ backgroundColor: "#eefff5" }}>
          <TableRow>
            {columnas.map((col) => (
...
export default TablaAprendizMongo;
